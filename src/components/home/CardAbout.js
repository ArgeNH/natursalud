...
export const CardAbout = ({ name, role, img, github, linkedin }) => {
    return (
        <>
            <div className="mb-12 lg:mb-0">
                <img className="rounded-lg shadow-lg mb-6 mx-auto" src={img}
                    alt={name} />
                <h5 className="text-lg font-bold mb-4">{name}</h5>
                <p className="mb-6">{role}</p>
                <ul className="list-inside flex mx-auto justify-center">
                    <a href={github} className="px-2" target='_blank' rel='noreferrer'>
                    ...
                    <a href={linkedin} className="px-2" target='_blank' rel='noreferrer'>
